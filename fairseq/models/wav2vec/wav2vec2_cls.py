...
@dataclass
class Wav2Vec2ClsConfig(FairseqDataclass):
    w2v_path: str = field(
...
@register_model("wav2vec_cls", dataclass=Wav2Vec2ClsConfig)
class Wav2VecCls(BaseFairseqModel):
    def __init__(self, cfg: Wav2Vec2ClsConfig, w2v_encoder: BaseFairseqModel):
        super().__init__()
        self.cfg = cfg
    ...
    @classmethod
    def build_model(cls, cfg: Wav2Vec2ClsConfig, task: FairseqTask):
        """Build a new model instance."""
        w2v_encoder = Wav2VecEncoder(cfg, cfg.num_classes)
...
class Wav2VecEncoder(FairseqEncoder):
    def __init__(self, cfg: Wav2Vec2ClsConfig, output_size=None):
    ...
    def forward(self, source, padding_mask, **kwargs):
        ...
        with torch.no_grad() if not ft else contextlib.ExitStack():
            ...
            # NOTE: Why in the original code they need this?
            # # B x T x C -> T x B x C
            # x = x.transpose(0, 1)
