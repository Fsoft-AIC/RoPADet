...
from fairseq.modules.conformer_layer import ConformerRoPADetEncoderLayer
...
@dataclass
class RoPADetConfig(FairseqDataclass):
    num_mel: int = field(
...
class RoPADetModel(BaseFairseqModel):
    def __init__(self, cfg: RoPADetConfig):
        super().__init__()
        self.cfg = cfg
    ...
    @classmethod
    def build_model(cls, cfg: RoPADetConfig, task=None):
...
class TransformerEncoder(nn.Module):
    def build_encoder_layer(self, args: RoPADetConfig):
        if args.layer_type == "transformer":
            ...
            layer = ConformerRoPADetEncoderLayer(
    ...
    def __init__(self, args: RoPADetConfig):
        super().__init__()
