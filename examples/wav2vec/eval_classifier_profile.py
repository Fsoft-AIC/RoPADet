...
import pandas as pd
import numpy as np
from utils import load_fairseq_dataset, evaluate, ProfileDataset, profile_collate_fn
...
task.cfg.profiles_path = '/media/Z/tungtk2/fairseq/outputs/2022-04-19/21-32-58/checkpoints/profile.pt'
# Load model
...
models, _model_args = checkpoint_utils.load_model_ensemble([args.path],  arg_overrides={'data': '/media/SSD/tungtk2/fairseq/data/orig_2048_128_aicovidvn_fold4', 'w2v_path': '/media/Z/tungtk2/fairseq/outputs/2022-04-19/21-32-58/checkpoints/checkpoint_best.pt'}, task=task)
model = models[0].cuda()
...
profiles = torch.load('/media/Z/tungtk2/fairseq/outputs/2022-04-19/21-32-58/checkpoints/profile.pt')
min_inp, min_out, min_id = load_fairseq_dataset('/media/SSD/tungtk2/fairseq/data/profile_2048_128', '/media/Z/tungtk2/aicv115m_api_template/', ['test'], profiling=True)
